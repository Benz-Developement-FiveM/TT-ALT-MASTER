...
Config.TimeBetweenHotwires = 500 -- Time in ms between hotwire attempts
Config.minHotwireTime = 2000 -- Minimum hotwire time in ms
Config.maxHotwireTime = 4000 --  Maximum hotwire time in ms

-- Police Alert Settings
Config.AlertCooldown = 10000 -- 10 seconds
Config.PoliceAlertChance = 0.01 -- Chance of alerting police during the day
Config.PoliceNightAlertChance = 0.01 -- Chance of alerting police at night (times:01-06)
