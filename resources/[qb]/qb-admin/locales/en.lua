Translations = {
    html = {
        ...
        ShowPlayerGraphTranslation = "Show Player Graph",
        SmallModeTranslation = "Small Mode",
    ...
    alerts = {
        ...
        sentTo = "Sent player to location.",
        ...
        repairedPlayerVehicle = "Repaired player vehicle",
    ...
    notify = {
        ...
        removedItem = "You had %{value} removed by staff."
    },
    logs = {
        names = {
