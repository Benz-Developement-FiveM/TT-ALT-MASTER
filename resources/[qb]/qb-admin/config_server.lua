...
Config.LogsWebhook                          = ""            -- Qbox/ESX only, set this to your admin actions webhook. If you are using QBCore, set your adminactions webhook in qb-smallresources/server/logs.lua
...
Config.DiscordBot.Enabled                   = false         -- Whether to enable or disable the Discord bot.
Config.DiscordBot.Token                     = ""            -- Your bot token.
Config.DiscordBot.Webhook                   = ""            -- Your bot webhook.
Config.DiscordBot.ChannelID                 = ""            -- The channel ID to send messages to.
...
Config.DiscordBot.FooterText                = "© 2024 919ADMIN - store.nineonenine.design"
