...
CommandCallbacks = {
    ...
    playerlist = function()
        local message = ""
        local PlayerList = Compat.GetPlayerList()
    ...
    playerinfo = function(args)
        ...
        local playerInfo = Compat.GetCharacterData(targetPlayer)
    ...
    reportreply = function(args)
        ...
        if Config.Framework == "qbcore" or Config.Framework == "qbox" then
            TriggerClientEvent("QBCore:Notify", targetPlayer, {text = "Report Reply", caption = message}, "info", 10000)
        elseif Config.Framework == "esx" then
            ESX.GetPlayerFromId(targetPlayer).showNotification("Report Reply: "..message, "info", 10000)
        end
    ...
    givemoney = function(args)
        ...
        if targetPlayer then
            ...
            if type == "cash" then
                Compat.PlayerActions.AddMoney(targetPlayer, amount)
            elseif type == "bank" then
                Compat.PlayerActions.AddBank(targetPlayer, amount)
            end
    ...
    removemoney = function(args)
        ...
        if targetPlayer then
            ...
            if type == "cash" then
                Compat.PlayerActions.RemoveMoney(targetPlayer, amount)
            elseif type == "bank" then
                Compat.PlayerActions.RemoveBank(targetPlayer, amount)
            end
    ...
    setjob = function(args)
        ...
        local playerName = GetPlayerName(targetPlayer)
        Compat.SetPlayerJob(targetPlayer, job, grade)
    ...
    setgang = function(args)
        ...
        local playerName = GetPlayerName(targetPlayer)
        Compat.SetPlayerGang(targetPlayer, gang, rank)
    ...
    firejob = function(args)
        ...
        local playerName = GetPlayerName(targetPlayer)
        Compat.SetPlayerJob(targetPlayer, "unemployed", 0)
    ...
    firegang = function(args)
        ...
        local playerName = GetPlayerName(targetPlayer)
        Compat.SetPlayerGang(targetPlayer, "none", 0)
    ...
    spawncar = function(args)
        ...
        local playerName = GetPlayerName(targetPlayer)
        TriggerClientEvent("QBCore:Command:SpawnVehicle", targetPlayer, model)
    ...
    clearinventory = function(args)
        ...
        local playerName = GetPlayerName(targetPlayer)
        Compat.ClearPlayerInventory(targetPlayer)
    ...
    getinventory = function(args)
        ...
        if Config.Framework == "qbcore" then
            if not Config.IsUsingOverextendedInventory then
                ...
                items = exports[Config.OxInventoryResourceName]:GetInventoryItems(targetPlayer)
                for k, v in pairs(items) do
