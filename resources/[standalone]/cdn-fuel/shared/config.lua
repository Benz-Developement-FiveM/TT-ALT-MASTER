...
Config.FuelTargetExport = false -- DO NOT USE WITH qb-target! This is only used to fix this qb-target issue: https://github.com/CodineDev/cdn-fuel/issues/3. <br> <br> If you don't have this issue and haven't installed this exports in qb-target, then this should be false. Otherwise there will be an error.
...
Config.TargetResource = "qb-target" -- Supported: { 'qb-target', 'qb-target'} -- Others must use the same format as qb-target or manual configuration is required.
