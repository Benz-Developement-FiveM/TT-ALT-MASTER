...
Config.Inventory = "New-QbInventory"  -- Choose your inventory system: New-QbInventory, Old-QbInventory, OX-Inventory, qs-inventory or custom
...
Config.UseCommandToCheckwin = true --If players can check if they've won the lottery using a command, specify 'true' or 'false'.
