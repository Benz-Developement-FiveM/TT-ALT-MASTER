Config.Locations = {
    ["Washing"] = {
        Enable = true,
        positions = {
            { name = "MINING:Stone Washing", coords = vec3(1840.18, 412.42, 160.49), sprite = 467, col = 3, disp = 6, blipEnable = true }, -- Mountains
            { name = "MINING:Stone Washing", coords = vec3(1870.91, 395.1, 160.16), sprite = 467, col = 3, disp = 6, blipEnable = false },

            { name = "MINING:Stone Washing", coords = vec3(-432.59, 2936.84, 13.87), sprite = 467, col = 3, disp = 6, blipEnable = true }, -- Stream Blip
            { name = "MINING:Stone Washing", coords = vec3(-422.37, 2946.18, 13.77), sprite = 467, col = 3, blipEnable = false },
            { name = "MINING:Stone Washing", coords = vec3(-443.21, 2926.5, 13.62), sprite = 467, col = 3, blipEnable = false },
            { name = "MINING:Stone Washing", coords = vec3(-455.48, 2917.16, 13.52), sprite = 467, col = 3, blipEnable = false },

            { name = "MINING:Stone Washing", coords = vec3(2500.64, 6129.4, 162.46), sprite = 467, col = 3, disp = 6, blipEnable = true }, -- Gordo

            { name = "MINING:Stone Washing", coords = vec3(907.06, 4377.66, 30.28), sprite = 467, col = 3, disp = 6, blipEnable = true }, -- Alamo Sea
            { name = "MINING:Stone Washing", coords = vec3(894.14, 4386.56, 30.24), sprite = 467, col = 3, blipEnable = false },
            { name = "MINING:Stone Washing", coords = vec3(893.12, 4370.74, 30.35), sprite = 467, col = 3, blipEnable = false },
            { name = "MINING:Stone Washing", coords = vec3(912.88, 4365.7, 30.39), sprite = 467, col = 3, blipEnable = false },
        },
    },
    ["Panning"] = {
        Enable = true,
	...
	['JewelBuyer'] = { -- The Location of the jewel buyer, I left this as Vangelico, others will proabably change to pawn shops
        Enable = true,
        positions = {
            { name = "MINING:Jewel Buyer", coords = vec4(-629.86, -240.35, 38.16, 110.05), sprite = 527, col = 617, blipTrue = false, model = `S_M_M_HighSec_03`, scenario = "WORLD_HUMAN_CLIPBOARD", },
        },
    },
    ["Smelting"] = {
        { name = "MINING:Foundary", coords = vec3(1112.29, -2009.9, 31.46), sprite = 436, col = 1, blipTrue = false, },
    },
    ...
    ["Mines"] = {
        ["Foundary"] = {
            ...
            Store = {
                { name = "MINING:Foundary Store", coords = vec4(1074.89, -1988.19, 30.89, 235.07), model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD", },
            },
            Smelting = {
                { blipEnable = true, name = "MINING:Foundary", coords = vec3(1112.29, -2009.9, 31.46), sprite = 436, col = 1,  },
            },
            Cracking = {
                { blipEnable = false, name = "MINING:Stone Cracking", coords = vec4(1109.19, -1992.8, 30.98, 146.88), sprite = 566, col = 81, prop = "prop_vertdrill_01" },
                { blipEnable = false, name = "MINING:Stone Cracking", coords = vec4(1105.56, -1992.53, 30.94, 238.19), sprite = 566, col = 81, prop = "prop_vertdrill_01" },
            },
            OreBuyer = {
                { blipEnable = false, name = "MINING:Ore Buyer", coords = vec4(1090.18, -1999.51, 30.93, 146.24), sprite = 568, col = 81, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD", },
            },
            JewelCut = {
                { blipEnable = false, name = "MINING:Jewel Cutting", coords = vec4(1077.11, -1984.22, 31.02, 235.8), sprite = 566, col = 81, prop = `gr_prop_gr_speeddrill_01c` },
                { blipEnable = false, name = "MINING:Jewel Cutting", coords = vec4(1075.19, -1985.45, 30.92, 144.89), sprite = 566, col = 81, prop = `gr_prop_gr_speeddrill_01c` },
            },
        },
        ["MineShaft"] = {
            Enable = true,
            ...
            Blip = {
                Enable = true,
                name = "MINING:Mine Shaft",
                coords = vec4(-596.74, 2090.99, 131.41, 16.6),
                sprite = 527,
                col = 81,
            },
            Store = {
                { name = "MINING:Mine", coords = vec4(-594.96, 2091.3, 131.47, 67.65), model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD",  },
            },
            Lights = {
                Enable = true,
                prop = "prop_worklight_02a",
        ...
        ["Quarry"] = {
            ...
            Store = {
                { name = "MINING:Quarry", coords = vec4(2960.9, 2754.14, 43.71, 204.58), model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD",  },
            },
            Lights = {
                Enable = true,
        ...
        ["K4MB1"] = { -- K4MB1's Mineshaft in the quarry
            ...
            Blip = {
                Enable = true,
                name = "MINING:Mining Cave",
                coords = vec4(2937.98, 2744.81, 43.28, 281.59),
                sprite = 527,
                col = 81,
            },
            Store = {
                { name = "MINING:Cave Shop", coords = vec4(2908.8, 2643.6, 43.26, 328.32), model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD", },
            },
            Smelting = {
                { blipEnable = true, name = "MINING:Smelter", coords = vec3(2921.81, 2653.42, 43.15), sprite = 436, col = 1, },
            },
            Cracking = {
                { name = "MINING:Stone Cracking", coords = vec4(2914.9, 2650.78, 43.08, 231.77), sprite = 566, col = 81, blipTrue = false, prop = `prop_vertdrill_01` }, -- Foundary
                { name = "MINING:Stone Cracking", coords = vec4(2914.61, 2649.06, 43.19, 272.74), sprite = 566, col = 81, blipTrue = false, prop = `prop_vertdrill_01` }, -- Foundary
            },
            OreBuyer = {
                { blipEnable = true, name = "MINING:Ore Buyer", coords = vec4(2917.79, 2646.26, 43.17, 6.14), sprite = 568, col = 81,model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD", },
            },
            JewelCut = {
                { blipEnable = true, name = "MINING:Jewel Cutting", coords = vec4(2917.45, 2654.24, 43.03, 229.61), sprite = 566, col = 81, prop = `gr_prop_gr_speeddrill_01c` },
                { blipEnable = true, name = "MINING:Jewel Cutting", coords = vec4(2919.89, 2656.36, 43.15, 199.99), sprite = 566, col = 81, prop = `gr_prop_gr_speeddrill_01c` },
            },
            OrePositions = {
