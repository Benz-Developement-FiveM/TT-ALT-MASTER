Config = {
    ...
    TargetZoneType = 3, -- 1: q_target, 2: bt_target, 3: qb-target, 4: qb-target
    ...
    DailyWidthdrawLimit = 100000, -- how much money can player withdraw from the cashier per day (24 hours), set to 0 to disable
    ...
    IT_LOCAL_RACE_WIN_CHANCE = 75, -- win chance (from 0 to 100), def: 100, 100 means that it's not *unlucky* at all
    IT_MAIN_EVENT_RACE_WIN_CHANCE = 75, -- win chance (from 0 to 100), def: 100, 100 means that it's not *unlucky* at all
