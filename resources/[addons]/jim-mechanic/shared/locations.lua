...
Config.Locations[#Config.Locations+1] = { --[[ GABZ ALTA STREET BENNYS ]]--
	...
	blip = {
		...
		label = "MECHANIC:Bennys Original Motorworks",
		color = 1,
		sprite = 446,
		disp = 6,
		scale = 0.7,
...
Config.Locations[#Config.Locations+1] = { --[[ LS CUSTOMS IN CITY ]]--
	...
	blip = {
		...
		label = "MECHANIC:Los Santos Customs",
		color = 81,
		sprite = 446,
		disp = 6,
		scale = 0.7,
...
Config.Locations[#Config.Locations+1] = { --[[ BENNYS NEXT TO PDM ]]--
	...
	blip = {
		...
		label = "MECHANIC:Bennys Workshop",
		color = 1,
		sprite = 446,
		disp = 6,
		scale = 0.7,
...
Config.Locations[#Config.Locations+1] = { --[[ REDLINE ]]--
    ...
    blip = {
        ...
        label = "MECHANIC:Redline Performance",
        color = 1,
        sprite = 446,
        disp = 6,
        scale = 0.7,
...
Config.Locations[#Config.Locations+1] = { --[[ RISING SUN ]]--
    ...
    blip = {
        coords = vec3(-336.84, -136.39, 39.01),
        label = "MECHANIC:Rising Sun Customs",
        color = 46,
        sprite = 446,
        disp = 6,
        scale = 0.7,
