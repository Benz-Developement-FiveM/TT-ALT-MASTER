Config = {
	...
	Harness = {
		...
		progOn = false,				-- if true add a progressBar to buckle harness
		progOff = false,				-- if true add a progressBar to unbuckle harness
	...
	Odometer = {
		...
		SeatbeltHideWhenBuckled = true, 	-- Hide seatlbelt icon when buckled
		HarnessHideWhenBuckled = true, 	-- Hide Harness icon when buckled
	...
	ManualRepairs = { -- Player vehicle repair config
		ManualRepairCost = 1000, 	-- Set this to a high amount to get people to talk to mechanics rather than use automated systems
		...
		ManualRepairPercent = 2,	-- Set this to the percent of the vehicle price (Only works if ManualRepairBased is true)
