...
PLT.UseEsxFramework = false                                  -- SET = (true or false), if you  want to use esx menu system and using esx framework set this true. or set false for menuv.
...
PLT.UseEsxSkin  = false                                      -- SET = (true or false), if you use esx_skin and skinchanger set true elseif set false and edit WearJob() and WearCitizen() functions on client.lua
