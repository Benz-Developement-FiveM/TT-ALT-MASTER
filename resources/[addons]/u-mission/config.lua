...
-- Framework
Config.Framework = 'qb-core' -- esx/qb-core if you use qb
...
Config.Prices = {
    lockpick = 5000, -- Price Of The Item
    phone = 1000, -- Price Of The Item
    radio = 1500, -- Price Of The Item
    carotool = 2000, -- Price Of The Item 
