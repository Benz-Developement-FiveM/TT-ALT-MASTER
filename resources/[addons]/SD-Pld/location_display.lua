...
Citizen.CreateThread(function()
    while true do
        ...
        local directionX, directionY = 0.01, 0.70 -- Direction text position
        local textX, textY = 0.015, 0.670-- Other text position
        local textWidth, textHeight = 0.15, 0.08 -- Background dimensions

        -- Draw the black background
        DrawBackground(textX, textY + 0.02, textWidth, textHeight, 0, 0, 0, 0) -- Semi-transparent black background
