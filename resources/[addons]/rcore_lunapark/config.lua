...
Config.Prices.RollerCoaster = 50 -- Ticket price for the Roller Coaster
Config.Prices.FerrisWheel   = 20 -- Ticket price for the Ferris Wheel
Config.Prices.Freefall      = 30 -- Ticket price for the Freefall
